...
var BITBOX = /** @class */ (function () {
    function BITBOX(config) {
        ...
        this.Block = new Block_1.Block(restURL);
        this.Blockchain = new Blockchain_1.Blockchain(restURL);
        this.Control = new Control_1.Control(restURL);
        this.Crypto = Crypto_1.Crypto;
        this.ECPair = ECPair_1.ECPair;
        this.ECPair.setAddress(this.Address);
        this.Generating = new Generating_1.Generating(restURL);
        this.HDNode = new HDNode_1.HDNode(this.Address);
        this.Mining = new Mining_1.Mining(restURL);
