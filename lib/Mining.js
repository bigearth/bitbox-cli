...
var Mining = function () {
  ...
  _createClass(Mining, [{
    ...
    value: function getBlockTemplate(template_request) {
      ...
      return _axios2.default.get(this.restURL + 'mining/getBlockTemplate/' + template_request).then(function (response) {
    ...
    value: function getMiningInfo() {
      ...
      return _axios2.default.get(this.restURL + 'mining/getMiningInfo').then(function (response) {
        return response.data;
      }).catch(function (error) {
    ...
    value: function getNetworkHashps() {
      ...
      return _axios2.default.get(this.restURL + 'mining/getNetworkHashps?nblocks=' + nblocks + '&height=' + height).then(function (response) {
        return response.data;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
