...
var BitcoinCash = function () {
  ...
  _createClass(BitcoinCash, null, [{
    ...
    value: function translateMnemonic(mnemonic) {
      ...
      var fromWordlist = BitcoinCash.mnemonicWordLists()[from.toLowerCase()];
      var toWordlist = BitcoinCash.mnemonicWordLists()[to.toLowerCase()];
      var entropy = BitcoinCash.mnemonicToEntropy(mnemonic, fromWordlist);
    ...
    value: function createHDWallet(config) {
      ...
      if (config.autogenerateHDMnemonic) {
        ...
        mnemonic = BitcoinCash.entropyToMnemonic(_randomBytes, BitcoinCash.mnemonicWordLists()[config.language]);
      }
    ...
    value: function encodeBIP21(address, options) {
      return _bip4.default.encode(BitcoinCash.toCashAddress(address), options);
    }
