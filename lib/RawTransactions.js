            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, axios.get(this.restURL + "rawtransactions/decodeRawTransaction/" + hex)];
                    case 1:
                        response = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, axios.get(this.restURL + "rawtransactions/decodeScript/" + script)];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, response.data];
                    case 2:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, axios.get(this.restURL + "rawtransactions/getRawTransaction/" + txid + "?verbose=" + verbose)];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, response.data];
                    case 2:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                        if (!(typeof hex === "string")) return [3 /*break*/, 2];
                        return [4 /*yield*/, axios.get(this.restURL + "rawtransactions/sendRawTransaction/" + hex)];
                    case 1:
                        response = _a.sent();
