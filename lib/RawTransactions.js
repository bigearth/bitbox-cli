...
var RawTransactions = function () {
  ...
  _createClass(RawTransactions, [{
    ...
    value: function sendRawTransaction(hexstring) {
      ...
      return _axios2.default.post(this.baseurl + 'rawtransactions/hexstring?allowhighfees=' + allowhighfees).then(function (response) {
        return response.data.result;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
