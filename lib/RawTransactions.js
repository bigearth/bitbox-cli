...
var RawTransactions = function () {
  function RawTransactions(restBaseURL) {
  ...
  _createClass(RawTransactions, [{
    ...
    value: function decodeRawTransaction(hex) {
      ...
      return _axios2.default.get(this.restBaseURL + 'rawtransactions/decodeRawTransaction/' + hex).then(function (response) {
    ...
    value: function decodeScript(hex) {
      ...
      return _axios2.default.get(this.restBaseURL + 'rawtransactions/decodeScript/' + hex).then(function (response) {
        return response.data;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
    ...
    value: function getRawTransaction(txid) {
      ...
      return _axios2.default.get(this.restBaseURL + 'rawtransactions/getRawTransaction/' + txid + '?verbose=' + verbose).then(function (response) {
        return response.data;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
    ...
    value: function sendRawTransaction(hex) {
      ...
      return _axios2.default.post(this.restBaseURL + 'rawtransactions/sendRawTransaction/' + hex + '?allowhighfees=' + allowhighfees).then(function (response) {
        return response.data;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
