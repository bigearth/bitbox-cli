...
var Network = function () {
  ...
  _createClass(Network, [{
    ...
    value: function addNode(node, command) {
      ...
      return _axios2.default.post(this.restURL + 'network/addNode/' + node + '/' + command).then(function (response) {
    ...
    value: function clearBanned() {
      ...
      return _axios2.default.post(this.restURL + 'clearBanned').then(function (response) {
        return response.data;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
    ...
    value: function disconnectNode(configuration) {
      ...
      return _axios2.default.post(this.restURL + 'disconnectNode/' + configuration).then(function (response) {
        return response.data;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
    ...
    value: function getConnectionCount() {
      ...
      return _axios2.default.get(this.restURL + 'network/getConnectionCount').then(function (response) {
        return response.data;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
    ...
    value: function getNetTotals() {
      ...
      return _axios2.default.get(this.restURL + 'network/getNetTotals').then(function (response) {
        return response.data;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
    ...
    value: function getNetworkInfo() {
      ...
      return _axios2.default.get(this.restURL + 'network/getNetworkInfo').then(function (response) {
        return response.data;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
    ...
    value: function getPeerInfo() {
      ...
      return _axios2.default.get(this.restURL + 'network/getPeerInfo').then(function (response) {
        return response.data;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
    ...
    value: function ping() {
      ...
      return _axios2.default.get(this.restURL + 'network/ping').then(function (response) {
        return response.data;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
