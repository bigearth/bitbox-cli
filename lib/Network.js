...
var Network = function () {
  ...
  _createClass(Network, [{
    ...
    value: function addNode(node, command) {
      ...
      return _axios2.default.post(this.baseURL + 'network/addNode/' + node + '/' + command).then(function (response) {
    ...
    value: function clearBanned() {
      ...
      return _axios2.default.post(this.baseURL + 'clearBanned').then(function (response) {
        return response.data.result;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
    ...
    value: function disconnectNode(configuration) {
      ...
      return _axios2.default.post(this.baseURL + 'disconnectNode/' + configuration).then(function (response) {
        return response.data.result;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
    ...
    value: function getConnectionCount() {
      ...
      return _axios2.default.get(this.baseURL + 'network/getConnectionCount').then(function (response) {
    ...
    value: function getNetTotals() {
      ...
      return _axios2.default.get(this.baseURL + 'network/getNetTotals').then(function (response) {
        return response.data.result;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
    ...
    value: function getNetworkInfo() {
      ...
      return _axios2.default.get(this.baseURL + 'network/getNetworkInfo').then(function (response) {
        return response.data.result;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
    ...
    value: function getPeerInfo() {
      ...
      return _axios2.default.get(this.baseURL + 'network/getPeerInfo').then(function (response) {
        return response.data.result;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
    ...
    value: function listBanned() {
      ...
      return _axios2.default.get(this.baseURL + 'network/listBanned').then(function (response) {
        return response.data.result;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
    ...
    value: function ping() {
      ...
      return _axios2.default.get(this.baseURL + 'network/ping').then(function (response) {
        return response.data.result;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
    ...
    value: function setBan(subnet, command, bantime, absolute) {
      ...
      return _axios2.default.post(this.baseurl + 'network/setban/' + subnet + '/' + command).then(function (response) {
        return response.data.result;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
    ...
    value: function setNetworkActive(state) {
      ...
      return _axios2.default.post(this.baseurl + 'network/setNetworkActive/' + state).then(function (response) {
        return response.data.result;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
