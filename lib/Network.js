...
var Network = function () {
  ...
  _createClass(Network, [{
    ...
    value: function addNode(node, command) {
      ...
      return _axios2.default.post(this.restBaseURL + 'network/addNode/' + node + '/' + command).then(function (response) {
    ...
    value: function clearBanned() {
      ...
      return _axios2.default.post(this.restBaseURL + 'clearBanned').then(function (response) {
        return response.data;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
    ...
    value: function disconnectNode(configuration) {
      ...
      return _axios2.default.post(this.restBaseURL + 'disconnectNode/' + configuration).then(function (response) {
        return response.data;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
    ...
    value: function getAddedNodeInfo(node) {
      ...
      //   ,...
      // ]
      var path = this.restBaseURL + 'network/getAddedNodeInfo';
      if (node) {
        path = path + '?node=' + node;
      }
    ...
    value: function getConnectionCount() {
      ...
      return _axios2.default.get(this.restBaseURL + 'network/getConnectionCount').then(function (response) {
        return response.data;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
    ...
    value: function getNetTotals() {
      ...
      return _axios2.default.get(this.restBaseURL + 'network/getNetTotals').then(function (response) {
        return response.data;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
    ...
    value: function getNetworkInfo() {
      ...
      return _axios2.default.get(this.restBaseURL + 'network/getNetworkInfo').then(function (response) {
        return response.data;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
    ...
    value: function getPeerInfo() {
      ...
      return _axios2.default.get(this.restBaseURL + 'network/getPeerInfo').then(function (response) {
        return response.data;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
    ...
    value: function ping() {
      ...
      return _axios2.default.get(this.restBaseURL + 'network/ping').then(function (response) {
        return response.data;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
