...
var Address = function () {
  ...
  _createClass(Address, [{
    ...
    value: function details(address) {
      ...
      return _axios2.default.get(this.restBaseURL + 'address/details/' + address).then(function (response) {
    ...
    value: function utxo(address) {
      ...
      return _axios2.default.get(this.restBaseURL + 'address/utxo/' + address).then(function (response) {
        return response.data;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
    ...
    value: function unconfirmed(address) {
      ...
      return _axios2.default.get(this.restBaseURL + 'address/unconfirmed/' + address).then(function (response) {
        return response.data;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
