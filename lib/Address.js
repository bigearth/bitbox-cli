...
var Address = function () {
  ...
  _createClass(Address, [{
    ...
    value: function details(address) {
      return _axios2.default.get('https://explorer.bitcoin.com/api/bch/addr/' + address).then(function (response) {
    ...
    value: function utxo(address) {
      return _axios2.default.get('https://explorer.bitcoin.com/api/bch/addr/' + address + '/utxo').then(function (response) {
        return response.data;
      }).catch(function (error) {
        return JSON.stringify(error.response.data.error.message);
      });
