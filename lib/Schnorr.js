...
var Schnorr = function () {
  ...
  _createClass(Schnorr, [{
    ...
    key: "pubKeyCombine",
    value: function pubKeyCombine(publicKeys, publicKeyHash) {
    ...
    key: "partialSigVerify",
    value: function partialSigVerify(session, partialSig, nonceCombined, idx, pubKey, nonce) {
      return _bipSchnorr2.default.muSig.partialSigVerify(session, partialSig, nonceCombined, idx, pubKey, nonce);
    }
  }, {
    key: "partialSigCombine",
    value: function partialSigCombine(nonceCombined, partialSigs) {
      return _bipSchnorr2.default.muSig.partialSigCombine(nonceCombined, partialSigs);
    }
  }, {
    key: "bufferToInt",
