...
var BITBOXCli = function () {
  ...
  _createClass(BITBOXCli, [{
    ...
    value: function abandonTransaction(txid) {
      ...
      var request = this.BitboxHTTP.get('abandontransaction', {
        params: {
          txid: txid
        }
    ...
    value: function addwitnessaddress(address) {
      ...
      var request = this.BitboxHTTP.get('addwitnessaddress', {
        params: {
          address: address
        }
      }).then(function (response) {
    ...
    key: 'bumpfee',
    value: function bumpfee(txid, options) {

      var request = this.BitboxHTTP.get('bumpfee', {
        params: {
          txid: txid,
          options: options
        }
