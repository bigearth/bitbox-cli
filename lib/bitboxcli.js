...
var BITBOXCli = function () {
  ...
  _createClass(BITBOXCli, [{
    ...
    value: function addmultisigaddress(Arguments, keys, account) {
    ...
    key: 'disconnectnode',
    value: function disconnectnode(address, nodeid) {
    ...
    value: function getreceivedbyaccount(accounts, minconf) {
    ...
    value: function importaddress(script, label, rescan, p2sh) {
      ...
      return this.BitboxHTTP({
        ...
        data: {
          ...
          params: [script, label, rescan, p2sh]
        }
      }).then(function (response) {
        return response.data.result;
      }).catch(function (error) {
    ...
    value: function listreceivedbyaccount(minconf, include_empty, include_watchonly) {
      ...
      return this.BitboxHTTP({
        ...
        data: {
          ...
          params: [minconf, include_empty, include_watchonly]
        }
      }).then(function (response) {
        return response.data.result;
      }).catch(function (error) {
    ...
    value: function listtransactions(account, count, skip, include_watchonly) {
      ...
      return this.BitboxHTTP({
        ...
        data: {
          ...
          params: [account, count, skip, include_watchonly]
        }
      }).then(function (response) {
        return response.data.result;
      }).catch(function (error) {
    ...
    key: 'listunspent',
    value: function listunspent(minconf, maxconf, addresses) {
    ...
    key: 'move',
    value: function move(fromaccount, toaccount, account, dummy, comment) {
      ...
      return this.BitboxHTTP({
        ...
        data: {
          ...
          id: "move",
          method: "move",
          params: [fromaccount, toaccount, account, dummy, comment]
        }
      }).then(function (response) {
        return response.data.result;
      }).catch(function (error) {
    ...
    value: function prioritisetransaction(txid, priority_delta, fee_delta) {
      ...
      return this.BitboxHTTP({
        ...
        data: {
          ...
          params: [txid, priority_delta, fee_delta]
        }
      }).then(function (response) {
        return response.data.result;
      }).catch(function (error) {
    ...
    value: function sendfrom(fromaccount, toaddress, amount, minconf, comment, comment_to) {
      ...
      return this.BitboxHTTP({
        ...
        data: {
          ...
          id: "sendfrom",
          method: "sendfrom",
          params: [fromaccount, toaddress, amount, minconf, comment, comment_to]
        }
      }).then(function (response) {
        return response.data.result;
      }).catch(function (error) {
    ...
    key: 'sendmany',
    value: function sendmany(fromaccount, ammounts, minconf, comment, subtractfeefrom) {
    ...
    value: function signrawtransaction(hexstring, prevtxs, privkeys, sighashtype) {
      ...
      return this.BitboxHTTP({
        ...
        data: {
          ...
          params: [hexstring, prevtxs, privkeys, sighashtype]
        }
      }).then(function (response) {
        return response.data.result;
      }).catch(function (error) {
    ...
    value: function walletpassphrasechange(passphrase, newPassphrase) {
      ...
      return this.BitboxHTTP({
        ...
        data: {
          ...
          params: [passphrase, newPassphrase]
        }
