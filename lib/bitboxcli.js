...
var BITBOXCli = function BITBOXCli(config) {
  ...
  this.Address = new _Address2.default(this.restBaseURL);
  this.BitcoinCash = new _BitcoinCash2.default();
  this.Block = new _Block2.default(this.restBaseURL);
  this.Blockchain = new _Blockchain2.default(this.restBaseURL);
  this.Control = new _Control2.default(this.restBaseURL);
  this.Crypto = _Crypto2.default;
  this.ECPair = _ECPair2.default;
  this.Generating = new _Generating2.default(this.restBaseURL);
  this.HDNode = new _HDNode2.default();
  this.Mining = new _Mining2.default(this.restBaseURL);
  this.Mnemonic = new _Mnemonic2.default();
  this.Network = new _Network2.default(this.restBaseURL);
  this.RawTransactions = new _RawTransactions2.default(this.restBaseURL);
  this.Script = new _Script2.default();
  this.Transaction = new _Transaction2.default(this.restBaseURL);
  this.TransactionBuilder = _TransactionBuilder2.default;
  this.Util = new _Util2.default(this.restBaseURL);
};
