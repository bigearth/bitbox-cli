...
var _Stealth = require('./Stealth');

var _Stealth2 = _interopRequireDefault(_Stealth);
...
var BITBOXCli = function BITBOXCli(config) {
  ...
  this.Wallet = new _Wallet2.default(config, this.baseURL);
  ...
  this.Stealth = new _Stealth2.default();
