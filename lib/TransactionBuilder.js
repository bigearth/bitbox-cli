...
var TransactionBuilder = function () {
  function TransactionBuilder() {
    ...
    this.transaction = new _bitcoincashjsLib2.default.TransactionBuilder(_bitcoincashjsLib2.default.networks[network]);
  ...
  _createClass(TransactionBuilder, [{
    ...
    value: function createMultisigAddress(required, pubKeys) {
      ...
      var redeemScript = _bitcoincashjsLib2.default.script.multisig.output.encode(required, pks.map(function (hex) {
        return Buffer.from(hex, 'hex');
      }));
      var scriptPubKey = _bitcoincashjsLib2.default.script.scriptHash.output.encode(_bitcoincashjsLib2.default.crypto.hash160(redeemScript));
      return _bchaddrjs2.default.toCashAddress(_bitcoincashjsLib2.default.address.fromOutputScript(scriptPubKey));
    }
  }]);
