...
async function testSend() {
  try {
    const hex1 = await buildTx(RECV_ADDR1)
    const hex2 = await buildTx(RECV_ADDR2)
...
// Build a TX hex that is ready to broadcast to the network.
async function buildTx(recAddr) {
  try {
