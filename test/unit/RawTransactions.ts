...
import { VerboseRawTransactionResult, DecodeRawTransactionResult } from "bitcoin-com-rest";
...
describe("#RawTransactions", (): void => {
  ...
  describe("#decodeRawTransaction", (): void => {
    it("should decode tx for a single hex", async (): Promise<any> => {
      ...
      const result: DecodeRawTransactionResult | DecodeRawTransactionResult[] = await bitbox.RawTransactions.decodeRawTransaction(hex)
    ...
    it("should decode an array of tx hexes", async (): Promise<any> => {
      ...
      const result: DecodeRawTransactionResult | DecodeRawTransactionResult[] = await bitbox.RawTransactions.decodeRawTransaction(hexes)
    ...
    it(`should throw error on array size rate limit`, async (): Promise<any> => {
      try {
        ...
        const result: DecodeRawTransactionResult | DecodeRawTransactionResult[] = await bitbox.RawTransactions.decodeRawTransaction(data)
        assert.equal(true, false, "Unexpected result!")
      } catch (err) {
  ...
  describe("#getRawTransaction", (): void => {
    it("should decode a single txid, with concise output", async (): Promise<any> => {
      const txid: string =
    ...
    it("should decode a single txid, with verbose output", async (): Promise<any> => {
      const txid: string =
        "23213453b4642a73b4fc30d3112d72549ca153a8707255b14373b59e43558de1"
    ...
    it("should decode an array of txids, with a concise output", async (): Promise<any> => {
      const txid: string[] = [
        "23213453b4642a73b4fc30d3112d72549ca153a8707255b14373b59e43558de1",
    ...
    it("should decode an array of txids, with a verbose output", async (): Promise<any> => {
      const txid: string[] = [
        "23213453b4642a73b4fc30d3112d72549ca153a8707255b14373b59e43558de1",
        "b25d24fbb42d84812ed2cb55797f10fdec41afc7906ab563d1ec8c8676a2037f"
      ]
    ...
    it(`should throw error on array size rate limit`, async (): Promise<any> => {
      try {
        ...
        const result: VerboseRawTransactionResult | VerboseRawTransactionResult[] = await bitbox.RawTransactions.getRawTransaction(data)
